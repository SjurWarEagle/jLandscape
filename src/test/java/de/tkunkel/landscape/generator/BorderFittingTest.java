...
class BorderFittingTest {
    ...
    public void checkFitting_circuit() throws IOException {
        ...
        MapTileCandidate circuit2 = loadMapTile("circuit/2.png");
        MapTileCandidate circuit3 = loadMapTile("circuit/3.png");
        MapTileCandidate circuit4 = loadMapTile("circuit/4.png");
        MapTileCandidate circuit5 = loadMapTile("circuit/5.png");
        MapTileCandidate circuit6 = loadMapTile("circuit/6.png");
        MapTileCandidate circuit7 = loadMapTile("circuit/7.png");
        MapTileCandidate circuit8 = loadMapTile("circuit/8.png");
        MapTileCandidate circuit9 = loadMapTile("circuit/9.png");
        MapTileCandidate circuit10 = loadMapTile("circuit/10.png");
        MapTileCandidate circuit11 = loadMapTile("circuit/11.png");
        MapTileCandidate circuit12 = loadMapTile("circuit/12.png");
